...
(deftheme some-nice-colors "DOCSTRING for some-nice-colors")
  (custom-theme-set-faces 'some-nice-colors
   ...
   '(font-lock-function-name-face ((t (:foreground "#8bd8fc" ))))
   '(font-lock-keyword-face ((t (:foreground "#bd6074" ))))
   '(font-lock-string-face ((t (:foreground "#fcd38b" ))))
   '(font-lock-type-face ((t (:foreground "#d3869b" ))))
   '(font-lock-constant-face ((t (:foreground "#d3869b" ))))
   '(font-lock-variable-name-face ((t (:foreground "#d2fff5" ))))
